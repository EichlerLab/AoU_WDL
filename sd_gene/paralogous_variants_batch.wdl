...
workflow ParalogousVariants {
  ...
  # ----------------------------------------------------------------------
  scatter (i in range(n_samples)) {
    Array[File] sample_best_match_fa  = [best_match.best_match_fa[2 * i], best_match.best_match_fa[2 * i + 1]]
    Array[File] sample_best_match_bed = [best_match.best_match_bed[2 * i], best_match.best_match_bed[2 * i + 1]]
